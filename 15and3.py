...
class LabelClass:
    def __init__(self):
        self.NNkeypoints=[[68.0, 46.0, 2], [13.0, 48.0, 2], [130.0, 45.0, 2]] # 存储标准关节点
        self.Point =[] #标准骨架节点坐标
        ...
        self.keyIndex = [0, 1, 2]
        # 关节点颜色
        self.color = ['aqua', 'darkred', 'red']
        self.lineIndex = [[1, 2], [1, 3]]
        ...
        self.canvas = None
        self.oval = [None for i in range(3)]  #画的点的索引
        self.ovalline = [None for i in range(2)]
        self.ovallineold = [None for i in range(2)]
    ...
    def LClick(self, event):
        ...
        if self.reLable:
            ...
            # 存储坐标点
            # print([event.x-250+self.size[0]/2, event.y-250+self.size[1]/2])
    ...
    def writeRes(self):
        ...
        filepath = os.path.abspath(os.curdir) + '/labeled/' + 'keypoints_pose17.txt'
        ...
        self.json_data['people'][0]['pose_keypoints_2d'] =[self.aa[0]] +self.keypoints[0:2] +self.aa[1:3] +[self.keypoints[2]] +self.aa[3:]
